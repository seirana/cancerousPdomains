...
// download button
    $('#download_btn_1').css('display', 'block');
    if(cancers.indexOf(d.name) != -1){
        $('#download_btn_1').attr("href", 'data:application/csv,'+encodeURIComponent('cancer,'+d.name + '\r\npfam,' + d.imports));
    }else{
        $('#download_btn_1').attr("href", 'data:application/csv,'+encodeURIComponent('pfam,'+d.name + '\r\ncancers,' + d.imports));
    }
    $('#download_btn_1').attr('download', d.name+'.csv');
}
